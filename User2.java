...
public class User {
	 ...
	 * brokerList	the  array list of all the brokers
	 */
	...
	/**
	 * Adds a new trading broker to the system if the broker of this name doesn't already exists
	 * @param name 				the name of the broker
	 * @param cryptoCoinList 	the array list of all the coins been requested
	 * @param strategy			trading strategy attached to the broker
	 * @return true if broker was added to the list, otherwise return false
	 */
	...
	/**
	 * Removes a trading broker from the system. If no broker of this name exist
	 * @param name
	 */
	...
	/**
	 * Initiates the trading process for all brokers logged into the system.
